...
#pragma warning restore 612, 618
    ...
    /// </summary>
    sealed partial class DbString : Beauty.DataAccess.SqlMapper.ICustomQueryParameter
    {
        /// <summary>
...
public class Connection
{
    ...
    /// ƒ¨»œ¡¨Ω”
    /// </summary>
    /// <param name="isSpecialCase">‘§¡Ù</param>
    public Connection()
    {
        string connType = "sqllite";
        ...
        switch (connType)
        {
            ...
            case "oracle":
                break;
            case "sqllite":
                string path = ConfigString.dbpath;
                _conn = (IDbConnection)new SQLiteConnection();
                SQLiteConnectionStringBuilder p = new SQLiteConnectionStringBuilder();
                p.DataSource = path;
                //p.Password = "654321";
                _conn.ConnectionString = p.ToString();
...
//if (!File.Exists(AppDomain.CurrentDomain.BaseDirectory + "\\" + dbName))
//{
//    SQLiteConnection.CreateFile(path);
//    SQLiteConnection conn = new SQLiteConnection();
//    System.Data.SQLite.SQLiteConnectionStringBuilder p1 = new System.Data.SQLite.SQLiteConnectionStringBuilder();
//    p1.DataSource = path;
//    conn.ConnectionString = p1.ToString();
//    conn.Open();
//    conn.ChangePassword("654321");
//    conn.Close();
